...
class BlankFragment : Fragment() {
    ...
    private val Consturl: String = "https://api.themoviedb.org/3/movie/top_rated?&api_key="
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        top = Tops(Consturl+"${BuildConfig.API_KEY}")
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        fun settingRecycler() {
            ...
            Recycler.adapter = RecyclerAdapter(/*this,*/ items,true){
